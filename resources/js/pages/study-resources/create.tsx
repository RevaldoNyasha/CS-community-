...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Add Resource', href: '/study-resources/create' },
];
...
export default function StudyResourceCreate({ subjects, types }: Props) {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Add Study Resource" />
            <div className="flex h-full flex-1 flex-col gap-4 p-4">
                <h1 className="text-2xl font-bold tracking-tight">Add Study Resource</h1>
                ...
                <form onSubmit={handleSubmit} className="max-w-2xl space-y-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            placeholder="https://..."
                        />
                        {errors.external_url && <p className="mt-1 text-sm text-red-500">{errors.external_url}</p>}
                    </div>
